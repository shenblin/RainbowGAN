...
class one2onestyleDataset(BaseDataset):
    """
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, opt.phase + 'A', 'Style_1')  # create a path '/path/to/data/trainA'
    ...
    def __getitem__(self, index):
        ...
        for style in range(self.opt.num_style-1):
            im_path = A_path.replace('Style_1','Style_'+str(style+2))
